...
/* @khbites: getting main.min from stylsheet = child theme director instead of roots parent */
  wp_enqueue_style('roots_main', get_stylesheet_directory_uri() . '/assets/css/main.min.css', false, '9880649384aea9f1ee166331c0a30daa');
